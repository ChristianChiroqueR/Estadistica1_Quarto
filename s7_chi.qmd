...
> ::: blockquote
> Luego de realizar una **prueba chi cuadrado**, a un 95% de confianza, obtuvimos un p-valor de 0.1264, por lo que **no podemos rechazar** la hipótesis nula (H0: No existe asociación). Por ello, concluimos que no existen asociación estadísticamente significativas entre la asistencia a manifestaciones y la procedencia de la persona a nivel poblacional.
> :::
