...
> ::: {.blockquote}
> Luego de realizar la *Prueba T para diferencia de medias*, dado que se obtuvo un p-valor (*2.2e-16*) que es menor que nuestro nivel de significancia establecido de 0.05, hay evidencia suficiente para rechazar la hipótesis nula. 
Por lo tanto, concluimos que existen diferencias estadísticamentes significativas en el monto mínimo promedio necesario para que un hogar pueda subsistir entre el área urbana y rural.
> :::
